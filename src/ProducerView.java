 ...
 * CS 2334, Section 012
 * April 21, 2016
 * This class creates the view for the producer data and contains
 * all associated methods.
 * 
 *@version 1.0
 */
public class ProducerView extends JFrame implements Serializable
{
	/**	 */
	private static final long serialVersionUID = -872954609873421766L;
	/** Stores a model */
	private MediaModel model;
	/** Stores a JPanel */
	protected JPanel producerPanel;
	...
	public ProducerView()
	{
		...
		mediaLabel1 = new JLabel("Select any movies producer has been in:");
		mediaLabel2 = new JLabel("Select any episodes producer has been in:");
		...
		producerPanel.setLayout(new GridBagLayout());
		...
		producerPanel.add(firstNameLabel, layoutConst);
		...
		producerPanel.add(firstNameField, layoutConst);
		...
		producerPanel.add(lastNameLabel, layoutConst);
		...
		producerPanel.add(lastNameField, layoutConst);
		...
		producerPanel.add(mediaLabel1, layoutConst);
		
		//Sets the grid position to the 1st column while staying in the 2nd row
		layoutConst.gridx = 1;
		//adds the mediaLabel1 component to the panel with the layout constraints
		producerPanel.add(mediaLabel2, layoutConst);
		...
		producerPanel.add(movieScrollPane, layoutConst);
		...
		producerPanel.add(episodeScrollPane, layoutConst);
		...
		producerPanel.add(addMovieButton, layoutConst);
		...
		producerPanel.add(addEpisodeButton, layoutConst);
		...
		producerPanel.add(confirmButton, layoutConst);
		...
		producerPanel.add(cancelButton, layoutConst);
