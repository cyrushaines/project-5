 ...
 * APR 21, 2016
 * <P>
 * This class creates the view for the director data and contains
...
public class DirectorView extends JFrame{
	...
	/** Stores a text field for entering data for first name */
	protected JTextField firstNameField;
	
	/** Stores a last name prompt label */
	private JLabel lastNameLabel;
	
	/** Stores a text field for entering data for last name */
	...
	/** Stores a scrolling pane that stores text area for movie */
	private JScrollPane movieScrollPane;
	
	/** Stores a text area for movie */
	protected JList movieList;
	
	/** stores scrolling pane that stores text area for episode */
	private JScrollPane episodeScrollPane;
	
	/** stores text area for episode */
	...
	public DirectorView()
	{
		...
		mediaLabel1 = new JLabel("Select any movies director has been in:");
		mediaLabel2 = new JLabel("Select any episodes director has been in:");
		...
		directorPanel.add(firstNameLabel, layoutConst);
		...
		directorPanel.add(firstNameField, layoutConst);
		...
		directorPanel.add(lastNameLabel, layoutConst);
		...
		directorPanel.add(lastNameField, layoutConst);
		...
		directorPanel.add(mediaLabel1, layoutConst);
		
		//Sets the grid position to the 1st column while staying in the 2nd row
		layoutConst.gridx = 1;
		//adds the mediaLabel1 component to the panel with the layout constraints
		directorPanel.add(mediaLabel2, layoutConst);
		...
		directorPanel.add(movieScrollPane, layoutConst);
		...
		directorPanel.add(episodeScrollPane, layoutConst);
		...
		directorPanel.add(addMovieButton, layoutConst);
		...
		directorPanel.add(addEpisodeButton, layoutConst);
		...
		directorPanel.add(confirmButton, layoutConst);
		...
		directorPanel.add(cancelButton, layoutConst);
		
		//Adds the panel component to this JFrame
		this.add(directorPanel);
